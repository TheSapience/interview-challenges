# The Sapience interview challenges

Welcome! We're excited to be considering you for a full-stack engineering role at The Sapience. This folder (which will be the basis for a private GitHub repository) contains several engineering challenges for you to complete over the next few days.
...
Each challenge will introduce new tools and libraries, but you aren't expected to be familiar with them already. They're straightforward enough that you should be able to pick them up on the fly. We use these exact same tools inside The Sapience, so if you end up joining the team, you'll be well prepared for the job.
...
You probably got this code as a ZIP file that you unzipped. You should upload this to a new private GitHub repository and start working on it there. Once you're done with the challenge, invite the `The Sapience` account as a collaborator on your repository and ping the The Sapience team to let us know you're done. We'll then start reviewing your work!
